...
def forced_seir(y, t):
    ...
    dS = mu * (N - S) - beta_t * S * I / N
    dE = beta_t * S * I / N - (mu + sigma) * E
...
ax2.plot(t_plot, I1, color=color_1, linewidth=1.5, label='E(0)=0.01N')
ax2.plot(t_plot, I2, color=color_2, linewidth=1.5, label='E(0)=0.001N')
